...
export function ReportsPage() {
  return (
    <PageWrapper
      ...
      description="Monitor platform performance, donations, and engagement trends."
    >
          ...
          <CardContent className="p-6">
            ...
            <div className="h-[280px] w-full min-w-0">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  <defs>
                    <linearGradient id="reportsFillDonations" x1="0" y1="0" x2="0" y2="1">
                      <stop
                        offset="0%"
